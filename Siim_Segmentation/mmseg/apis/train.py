...
from mmseg.datasets import build_dataloader, build_siim_dataloader, build_dataset
...
def train_segmentor(model,
    ...
    data_loaders = [build_siim_dataloader(ds, **train_loader_cfg) for ds in dataset]
